...
function testFactory({ is_ipv4, source_string, source_byte_array, target_string, target_byte_array, }) {
...
describe('equality', () => {
    ...
    test('3', () => {
        expect(new IP('fe80:00de:00ad:0000:0000:0000:0000:0001').equals(new IP('fe80:de:ad::1'))).toBe(true);
    });
});
describe('subnets', () => {
    describe('IPv4', () => {
